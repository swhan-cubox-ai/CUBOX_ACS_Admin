...
//        HashMap doorGroupDetail = doorService.getDoorGroupDetail(commandMap);
    ...
    // 출입문 그룹 관리 등록/수정
    @RequestMapping(value = "/group/add.do", method= RequestMethod.PUT)
    ...
    @RequestMapping(value = "/schedule/add.do", method= RequestMethod.PUT)
     ...
     * @throws Exception
     */
    @RequestMapping(value = "/schedule/day/add.do", method= RequestMethod.PUT)
    ...
    // 출입문 알람 그룹 등록
    @RequestMapping(value = "/group/add.do", method= RequestMethod.PUT)
    public ModelAndView alarmGroupAdd(ModelMap model, @RequestParam Map<String, Object> commandMap, RedirectAttributes redirectAttributes) throws Exception {
