      ...
      success: function (returnData) {
        if (returnData.result == "success") {
          Swal.fire({
            ...
            window.location.href = '/auth/door/list2.do';
          });
        } else {
          alert("ERROR!");
          return;
...
<form id="wbFrm" name="wbFrm">
  <input type="hidden" id="deptCd" name="deptCd" value='<c:out value="${data.deptCd}"/>'/>
